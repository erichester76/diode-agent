#!/usr/bin/env python
"""Translate from prometheus output format to Diode SDK entities."""
...
def translate_device(device_info: dict) -> Device:
    """
    Translate device information from prometheus format to Diode SDK Device entity.
...
def translate_interface(
    ...
    """
    Translate interface information from prometheus format to Diode SDK Interface entity.
...
def translate_data(data: dict) -> Iterable[Entity]:
    """
    Translate data from prometheus format to Diode SDK entities.
